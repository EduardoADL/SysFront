...
const Home = () => {
    ...
    return(
        <div className="flex items-center flex-col w-screen h-screen bg-cover" style={{backgroundImage:`url(${bg})`}}>
            <Menu/>
            <div className="flex w-9/12 max-w-[1140px] mt-20 lg:mt-[200px] justify-center flex-col">
            ...
            <button className="animate-pulse max-w-[1140px] font-lethalforce w-9/12 mt-[7%] mb-[10%] bg-white rounded-xl p-4 text-green-500 text-xl lg:text-2xl">Acesse ou crie sua conta agora!</button>
        </div>
    )
}
export default Home;